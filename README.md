...
[`SkylightError`](./src/skylight_sdk/models/skylighterror.py) is the base class for all HTTP error responses. It has the following properties:
...
### Error Classes
**Primary errors:**
* [`SkylightError`](./src/skylight_sdk/models/skylighterror.py): The base class for HTTP error responses.
  * [`HTTPValidationError`](./src/skylight_sdk/models/httpvalidationerror.py): Validation Error. Status code `422`. *
  * [`ForbiddenErrorResponse`](./src/skylight_sdk/models/forbiddenerrorresponse.py): Returned when the request cannot be processed due to authentication or authorization issues. Status code `403`. *
...
**Inherit from [`SkylightError`](./src/skylight_sdk/models/skylighterror.py)**:
* [`InteractModelsErrorResponse`](./src/skylight_sdk/models/interactmodelserrorresponse.py): Applicable to 14 of 20 methods.*
* [`WindowsModelsErrorResponse`](./src/skylight_sdk/models/windowsmodelserrorresponse.py): Standard error response containing details about the error. Status code `500`. Applicable to 6 of 20 methods.*
* [`ResponseValidationError`](./src/skylight_sdk/models/responsevalidationerror.py): Type mismatch between the response data and the expected Pydantic model. Provides access to the Pydantic validation error via the `cause` attribute.
